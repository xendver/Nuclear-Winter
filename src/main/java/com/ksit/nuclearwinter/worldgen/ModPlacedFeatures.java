...
public class ModPlacedFeatures {
    public static final ResourceKey<PlacedFeature> URAN_ORE_PLACED_KEY = registerKey("uranium_ore");
    public static final ResourceKey<PlacedFeature> LEAD_ORE_PLACED_KEY = registerKey("lead_ore");
    ...
    private static ResourceKey<PlacedFeature> registerKey(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation.fromNamespaceAndPath(NuclearWinter.MOD_ID, name));
    }

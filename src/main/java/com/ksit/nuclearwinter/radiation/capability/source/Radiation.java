...
public class Radiation implements IRadiation {
    ...
    public Radiation(float initialPower, float radius, float decayPerChunk) {
    ...
    @Override
    public void setInitialPower(float p) {
        this.initialPower = p;
    }
    ...
    @Override
    public float getDecayPerChunk() {
        return decayPerChunk;
    }

    @Override
    public void setDecayPerChunk(float d) {
        this.decayPerChunk = d;
    }
